...
public:
	zmqSubscribeKey(){}
	zmqSubscribeKey(string& bidderIP, unsigned short bidderPort,const string& bcIP, unsigned short bcManagerPort, unsigned short bcDataPort);
	void set(string& bidderIP, unsigned short bidderPort,const string& bcIP, unsigned short bcManagerPort, unsigned short bcDataPort);
...
public:
	zmqSubKeyManager();
	string& add_subKey(string& bidder_ip, unsigned short bidder_port, const string& bc_ip,
	...
	bool keyExist(const string& bcIp, unsigned short managerPort);
...
public:
	...
	void registerBCToThrottle(string& ip, unsigned short port);
	...
	bool set_publishKey_registed(const string& ip, unsigned short managerPort,const string& publishKey);
...
public:
	...
	void init(vector<throttleConfig*>& thro_conf);
	...
	void add_throttle_identify(string& throttleIP, unsigned short throttlePort, string& identify);
	void registerBCToThrottle(string& ip, unsigned short port);
	void registerBCToThrottle(string &ip, unsigned short port, const string &throttle_ip, unsigned short throttle_mangerPort);
	...
	bool dropDev();
	bool recvHeartReq(const string &ip, unsigned short port);
	~throttleManager();
private:
