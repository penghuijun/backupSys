...
void configureObject::display(shared_ptr<spdlog::logger>& configLog) 
{
    g_manager_logger->info("-----------------------------------");    
    m_throttle_info.display(configLog);
    m_bidder_info.display(configLog);
    m_bc_info.display(configLog);
