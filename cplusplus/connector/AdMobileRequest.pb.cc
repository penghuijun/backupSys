...
void protobuf_AssignDesc_AdMobileRequest_2eproto() {
  ...
  static const int MobileAdRequest_offsets_[32] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MobileAdRequest, displaymanager_),
  };
  ...
  static const int MobileAdRequest_Device_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MobileAdRequest_Device, dnt_),
  };
...
void protobuf_AddDesc_AdMobileRequest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "alNumber\030\037 \001(\t\022\026\n\016displaymanager\030  \001(\t\032\213"
    "\001\n\006Device\022\016\n\006vender\030\001 \001(\t\022\021\n\tmodelName\030\002"
    " \001(\t\022\025\n\rmarketingName\030\003 \001(\t\022\023\n\013screenWid"
    "th\030\004 \001(\t\022\024\n\014screenHeight\030\005 \001(\t\022\017\n\007densit"
    "y\030\006 \001(\t\022\013\n\003dnt\030\007 \001(\t\032\266\001\n\004User\022\013\n\003uid\030\001 \001"
    "(\t\022A\n\006gender\030\002 \001(\01621.com.rj.protos.mobil"
    "e.MobileAdRequest.User.Gender\022\013\n\003Age\030\003 \001"
    ...
    "RTRAIT\020\001B,\n\024com.rj.protos.mobileB\024Mobile"
    "AdRequestProto", 1574);
...
const int MobileAdRequest_Device::kDntFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_dnt;
        break;
      }
...
const int MobileAdRequest::kDisplaymanagerFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 31: {
        ...
        if (input->ExpectTag(258)) goto parse_displaymanager;
        break;
      }
