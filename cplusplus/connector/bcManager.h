...
public:
	bidderCollecter(){}
	bidderCollecter(const string &bidder_ip, unsigned short bidder_port,const string& bc_ip, unsigned short bc_managerPort, unsigned short bc_dataPort);
	void set(const string &bidder_ip, unsigned short bidder_port,const string& bc_ip, unsigned short bc_managerPort, unsigned short bc_dataPort);
	...
	bool loginOrHeartReqToBc(const string &bidderIP, unsigned short bidderPort, vector<string> &unsubKeyList);
...
public:
	...
	void init(connectorConfig& conn_conf,const vector<bcConfig*>& bc_conf_list);
	...
	bool add_bc(zeromqConnect &connector,const string &bidder_ip, unsigned short bidder_port,
		const string& bc_ip, unsigned short bc_ManagerPort, unsigned short bc_dataPort);


	bool loginOrHeartReqToBc(const string &bidderIP, unsigned short bidderPort, vector<string> &unsubKeyList);
	void update_bc(const vector<bcConfig*>& bcConfList);
