...
public:
	...
	bool Tele_convertProtoToJson(string &reqTeleJsonData,const MobileAdRequest& mobile_request);	
	...
	bool GYin_ConvertProtoToProto(BidRequest& bidRequest,const MobileAdRequest& mobile_request);
	bool InMobi_AdReqJsonAddImp(Json::Value &impArray, const MobileAdRequest & mobile_request);
	bool Smaato_ConvertProtoToHttpGETArg(char *buf, const MobileAdRequest& mobile_request);
	...
	bool InMobi_ConvertProtoToJson(string & reqTeleJsonData,const MobileAdRequest & mobile_request);
	bool Baidu_ConvertProtoToHttpGETArg(char *buf, const MobileAdRequest& mobile_request);
